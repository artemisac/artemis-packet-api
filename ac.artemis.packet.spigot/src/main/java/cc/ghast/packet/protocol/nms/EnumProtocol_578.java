...
@AllArgsConstructor
@Getter
public enum EnumProtocol_578 implements EnumProtocol {
    HANDSHAKE(
            new PacketPair(
                new PacketInfo[]{
    ...
    PLAY(
            new PacketPair(
                new PacketInfo[] {
                        ...
                        new PacketInfo<>(0x0F, GPacketPlayClientKeepAlive.class, "PacketPlayInKeepAlive"),
                        // Todo find NMS name
                        new PacketInfo<>(0x10, PacketPlayClientDifficultyLock.class, "PacketPlayInLockDifficulty"),
                        new PacketInfo<>(0x11, GPacketPlayClientFlying.PacketPlayClientPosition.class,"PacketPlayInPosition"),
                        new PacketInfo<>(0x12, GPacketPlayClientFlying.PacketPlayClientPositionLook.class,"PacketPlayInPositionLook"),
                        new PacketInfo<>(0x13, GPacketPlayClientFlying.PacketPlayClientLook.class,"PacketPlayInLook"),
                        new PacketInfo<>(0x14, GPacketPlayClientFlying.class, "PacketPlayInFlying"),

                        new PacketInfo<>(0x15, GPacketPlayClientVehicleMove.class,"PacketPlayInVehicleMove"),
                        new PacketInfo<>(0x16, GPacketPlayClientBoatMove.class, "PacketPlayInSteerBoat"),
                        // Todo find NMS name
                        new PacketInfo<>(0x17, PacketPlayClientItemPick.class, "PacketPlayInPickItem"),
                        // Todo find NMS name
                        new PacketInfo<>(0x18, GPacketPlayClientCraftingPrepareGrid.class, "PacketPlayInCraftingPrepareGrid"),
                        new PacketInfo<>(0x19, GPacketPlayClientAbilities.class,"PacketPlayInAbilities"),
                        new PacketInfo<>(0x1A, GPacketPlayClientBlockDig.class,"PacketPlayInBlockDig"),
                        new PacketInfo<>(0x1B, GPacketPlayClientEntityAction.class,"PacketPlayInEntityAction"),
                        new PacketInfo<>(0x1C, GPacketPlayClientSteerVehicle.class,"PacketPlayInSteerVehicle"),
                        new PacketInfo<>(0x1D, GPacketPlayClientCraftingBookData.class, "PacketPlayInCraftBookData"),
                        // Todo find NMS name
                        new PacketInfo<>(0x1E, PacketPlayClientItemName.class, "PacketPlayInNameItem"),
                        new PacketInfo<>(0x1F, GPacketPlayClientResourcePackStatus.class, "PacketPlayInResourcePackStatus"),
                        new PacketInfo<>(0x20, GPacketPlayClientAdvancementTab.class, "PacketPlayInAdvancementTab"),
                        // Todo find NMS name
                        ...
                        new PacketInfo<>(0x23, GPacketPlayClientHeldItemSlot.class,"PacketPlayInHeldItemSlot"),
                        // Todo find NMS name
                        ...
                        new PacketInfo<>(0x26, GPacketPlayClientSetCreativeSlot.class,"PacketPlayInSetCreativeSlot"),
                        // Todo find NMS name
                        ...
                        new PacketInfo<>(0x29, GPacketPlayClientUpdateSign.class,"PacketPlayInUpdateSign"),
                        new PacketInfo<>(0x2A, GPacketPlayClientArmAnimation.class,"PacketPlayInArmAnimation"),
                        new PacketInfo<>(0x2B, GPacketPlayClientSpectate.class, "PacketPlayInSpectate"),
                        new PacketInfo<>(0x2C, GPacketPlayClientBlockPlace.class,"PacketPlayInBlockPlace"),
                        new PacketInfo<>(0x2D, GPacketPlayClientItemUse.class, "PacketPlayInUseItem")
                ...
                new PacketInfo[] {
                        ...
                        new PacketInfo<>(0x08, PacketPlayServerPlayerDigging.class, "PacketPlayOutPlayerDig"),
                        new PacketInfo<>(0x09, GPacketPlayServerBlockBreakAnimation.class, "PacketPlayOutBlockBreakAnimation"),
                        new PacketInfo<>(0x0A, PacketPlayServerTileEntityData.class, "PacketPlayOutTileEntityData"),
                        new PacketInfo<>(0x0B, GPacketPlayServerBlockAction.class, "PacketPlayOutBlockAction"),
                        new PacketInfo<>(0x0C, GPacketPlayServerBlockChange.class, "PacketPlayOutBlockChange"),
                        new PacketInfo<>(0x0D, PacketPlayServerBossBar.class, "PacketPlayOutBoss"),
                        new PacketInfo<>(0x0E, PacketPlayServerServerDifficulty.class, "PacketPlayOutServerDifficulty"),
                        ...
                        new PacketInfo<>(0x11, GPacketPlayServerTabComplete.class, "PacketPlayOutTabComplete"),
                        // Todo figure out NMS name for this
                        new PacketInfo<>(0x12, PacketPlayServerCommandsDeclare.class, "PacketPlayOutDeclareCommands"),
                        new PacketInfo<>(0x13, GPacketPlayServerTransaction.class, "PacketPlayOutTransaction"),
                        new PacketInfo<>(0x14, PacketPlayClientWindowClose.class, "PacketPlayInCloseWindow"),
                        ...
                        new PacketInfo<>(0x1D, GPacketPlayServerExplosion.class, "PacketPlayOutExplosion"),
                        new PacketInfo<>(0x1E, GPacketPlayServerChunkUnload.class, "PacketPlayOutUnloadChunk"),
                        new PacketInfo<>(0x1F, PacketPlayServerGameStateChange.class, "PacketPlayOutGameStateChange"),
                        // Todo find NMS
                        new PacketInfo<>(0x20, PacketPlayClientWindowHorse.class, "PacketPlayOutOpenHorseWindow"),
                        ...
                        new PacketInfo<>(0x25 , PacketPlayServerUpdateLight.class, "PacketPlayOutUpdateLight"),
                        // AKA Join Game
                        new PacketInfo<>(0x26, GPacketPlayServerLogin.class, "PacketPlayOutLogin"),
                        // AKA Map
                        new PacketInfo<>(0x27, PacketPlayServerMap.class, "PacketPlayOutMap"),
                        // Todo find NMS
                        new PacketInfo<>(0x28, PacketPlayServerTradeList.class, "PacketPlayOutTradeList"),
                        new PacketInfo<>(0x29, GPacketPlayServerEntity.GPacketPlayServerRelEntityMove.class, "PacketPlayOutRelEntityMove"),
                        new PacketInfo<>(0x2A, GPacketPlayServerEntity.GPacketPlayServerRelEntityMoveLook.class, "PacketPlayOutRelEntityMoveLook"),
                        new PacketInfo<>(0x2B, GPacketPlayServerEntity.GPacketPlayServerEntityLook.class, "PacketPlayOutEntityLook"),
                        new PacketInfo<>(0x2C, GPacketPlayServerEntity.class, "PacketPlayOutEntity"),
                        new PacketInfo<>(0x2D, PacketPlayClientVehicleMove.class, "PacketPlayInVehicleMove"),
                        // Todo find NMS
                        new PacketInfo<>(0x2E, PacketPlayServerBookOpen.class, "PacketPlayInOpenBook"),
                        new PacketInfo<>(0x2F, GPacketPlayServerWindowOpen.class, "PacketPlayOutOpenWindow"),

                        new PacketInfo<>(0x30, PacketPlayServerOpenSignEditor.class, "PacketPlayOutOpenSignEditor"),
                        // Todo figure out the MS name for this
                        new PacketInfo<>(0x31, PacketPlayServerCraftingRecipeResponse.class, "PacketPlayOutCraftingResponse"),
                        new PacketInfo<>(0x32, GPacketPlayServerAbilities.class, "PacketPlayOutAbilities"),
                        new PacketInfo<>(0x33, PacketPlayServerCombatEvent.class, "PacketPlayOutCombatEvent"),
                        // AKA Packet List Item
                        new PacketInfo<>(0x34, PacketPlayServerPlayerInfo.class, "PacketPlayOutPlayerInfo"),
                        // Todo figure out NMS name for this
                        new PacketInfo<>(0x35, PacketPlayServerPlayerFace.class, "PacketPlayOutFacePlayer"),
                        new PacketInfo<>(0x36, GPacketPlayServerPosition.class, "PacketPlayOutPosition"),

                        new PacketInfo<>(0x37, PacketPlayServerCraftingRecipeUnlock.class, "PacketPlayOutUnlockRecipe"),
                        new PacketInfo<>(0x38, GPacketPlayServerEntityDestroy.class, "PacketPlayOutEntityDestroy"),
                        new PacketInfo<>(0x39, GPacketPlayServerEntityEffectRemove.class, "PacketPlayOutRemoveEntityEffect"),
                        new PacketInfo<>(0x3A, GPacketPlayServerResourcePackSend.class, "PacketPlayOutResourcePackSend"),
                        new PacketInfo<>(0x3B, GPacketPlayServerRespawn.class, "PacketPlayOutRespawn"),
                        new PacketInfo<>(0x3C, GPacketPlayServerEntityHeadRotation.class, "PacketPlayOutEntityHeadRotation"),
                        // Todo figure out the NMS name for this
                        new PacketInfo<>(0x3D, PacketPlayServerAdvancementProgress.class, "PacketPlayOutAdvancementProgress"),
                        new PacketInfo<>(0x3E, PacketPlayServerWorldBorder.class, "PacketPlayOutWorldBorder"),
                        new PacketInfo<>(0x3F, PacketPlayServerCamera.class, "PacketPlayOutCamera"),
                        new PacketInfo<>(0x40, GPacketPlayServerHeldItemSlot.class, "PacketPlayOutHeldItemSlot"),
                        // Todo figure out the NMS name for this
                        new PacketInfo<>(0x41, PacketPlayServerUpdateViewPosition.class, "PacketPlayOutUpdateViewPosition"),
                        // Todo figure out the NMS name for this
                        new PacketInfo<>(0x42, PacketPlayServerUpdateViewDistance.class, "PacketPlayOutUpdateViewDistance"),
                        ...
                        new PacketInfo<>(0x4E, PacketPlayServerSpawnPosition.class, "PacketPlayOutSpawnPosition"),
                        new PacketInfo<>(0x4F, PacketPlayServerUpdateTime.class, "PacketPlayOutUpdateTime"),
                        new PacketInfo<>(0x50, PacketPlayServerTitle.class, "PacketPlayOutTitle"),
                        // Todo find NMS name
                        new PacketInfo<>(0x51, PacketPlayServerSoundEffectEntity.class, "PacketPlayOutEntitySoundEffect"),
                        new PacketInfo<>(0x52, PacketPlayServerSoundEffectCustom.class, "PacketPlayOutCustomSoundEffect"),
                        // Todo find NMS name
                        new PacketInfo<>(0x53, PacketPlayServerSoundEffectStop.class, "PacketPlayOutStopSound"),

                        new PacketInfo<>(0x54, PacketPlayServerPlayerListHeaderFooter.class, "PacketPlayOutPlayListHeaderFooter"),
                        new PacketInfo<>(0x55, PacketPlayServerMetadataResponse.class, "PacketPlayOutMetadataResponse"),
                        new PacketInfo<>(0x56, PacketPlayServerCollect.class, "PacketPlayOutCollect"),
                        new PacketInfo<>(0x57, GPacketPlayServerEntityTeleport.class, "PacketPlayOutEntityTeleport"),
                        // Todo find NMS name
                        new PacketInfo<>(0x58, PacketPlayServerAdvancements.class, "PacketPlayOutAdvancements"),
                        new PacketInfo<>(0x59, GPacketPlayServerUpdateAttributes.class,  "PacketPlayOutUpdateAttributes"),
                        new PacketInfo<>(0x5A, GPacketPlayServerEntityEffect.class,"PacketPlayOutEntityEffect"),
                        // Todo find NMS name
                        new PacketInfo<>(0x5B, PacketPlayServerCraftingRecipeDeclare.class, "PacketPlayOutDeclareRecipes"),
                        // Todo find NMS name
                        // AKA Tags
                        new PacketInfo<>(0x5C, PacketPlayServerMetadata.class, "PacketPlayOutMetadata"),
                        // Find NMS Name
                }
            )
    ),
