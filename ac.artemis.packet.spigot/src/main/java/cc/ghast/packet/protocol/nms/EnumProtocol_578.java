    ...
    PLAY(
            new PacketPair(
                ...
                new PacketInfo[] {
                        ...
                        new PacketInfo<>(0x09, PacketPlayServerBlockBreakAnimation.class, "PacketPlayOutBlockBreakAnimation"),
                        new PacketInfo<>(0x0A, PacketPlayServerTileEntityData.class, "PacketPlayOutTileEntityData"),
                        new PacketInfo<>(0x0B, PacketPlayServerBlockAction.class, "PacketPlayOutBlockAction"),
                        new PacketInfo<>(0x0C, PacketPlayServerBlockChange.class, "PacketPlayOutBlockChange"),
                        ...
                        new PacketInfo<>(0x11, PacketPlayServerTabComplete.class, "PacketPlayOutTabComplete"),
                        // Todo figure out NMS name for this
                        new PacketInfo<>(0x12, PacketPlayServerCommandsDeclare.class, "PacketPlayOutDeclareCommands"),
                        new PacketInfo<>(0x13, PacketPlayServerTransaction.class, "PacketPlayOutTransaction"),
                        ...
                        new PacketInfo<>(0x1D, PacketPlayServerExplosion.class, "PacketPlayOutExplosion"),
                        new PacketInfo<>(0x1E, PacketPlayServerChunkUnload.class, "PacketPlayOutUnloadChunk"),
                        ...
                        // AKA Join Game
                        new PacketInfo<>(0x26, PacketPlayServerLogin.class, "PacketPlayOutLogin"),
                        // AKA Map
                        ...
                        new PacketInfo<>(0x29, PacketPlayServerEntity.PacketPlayServerRelEntityMove.class, "PacketPlayOutRelEntityMove"),
                        new PacketInfo<>(0x2A, PacketPlayServerEntity.PacketPlayServerRelEntityMoveLook.class, "PacketPlayOutRelEntityMoveLook"),
                        new PacketInfo<>(0x2B, PacketPlayServerEntity.PacketPlayServerEntityLook.class, "PacketPlayOutEntityLook"),
                        new PacketInfo<>(0x2C, PacketPlayServerEntity.class, "PacketPlayOutEntity"),
                        ...
                        new PacketInfo<>(0x2F, PacketPlayServerWindowOpen.class, "PacketPlayOutOpenWindow"),
                        ...
                        new PacketInfo<>(0x32, PacketPlayServerAbilities.class, "PacketPlayOutAbilities"),
                        ...
                        new PacketInfo<>(0x36, PacketPlayServerPosition.class, "PacketPlayOutPosition"),

                        new PacketInfo<>(0x37, PacketPlayServerCraftingRecipeUnlock.class, "PacketPlayOutUnlockRecipe"),
                        new PacketInfo<>(0x38, PacketPlayServerEntityDestroy.class, "PacketPlayOutEntityDestroy"),
                        new PacketInfo<>(0x39, PacketPlayServerEntityEffectRemove.class, "PacketPlayOutRemoveEntityEffect"),
                        new PacketInfo<>(0x3A, PacketPlayServerResourcePackSend.class, "PacketPlayOutResourcePackSend"),
                        new PacketInfo<>(0x3B, PacketPlayServerRespawn.class, "PacketPlayOutRespawn"),
                        new PacketInfo<>(0x3C, PacketPlayServerEntityHeadRotation.class, "PacketPlayOutEntityHeadRotation"),
                        ...
                        new PacketInfo<>(0x40, PacketPlayServerHeldItemSlot.class, "PacketPlayOutHeldItemSlot"),
                        // Todo figure out the NMS name for this
                        ...
                        new PacketInfo<>(0x44, PacketPlayServerEntityMetadata.class, "PacketPlayOutEntityMetadata"),
                        new PacketInfo<>(0x45, PacketPlayServerEntityAttach.class, "PacketPlayOutAttachEntity"),
                        new PacketInfo<>(0x46, PacketPlayServerEntityVelocity.class, "PacketPlayOutEntityVelocity"),
                        new PacketInfo<>(0x47, PacketPlayServerEntityEquipment.class, "PacketPlayOutEntityEquipment"),
                        ...
                        new PacketInfo<>(0x57, PacketPlayServerEntityTeleport.class, "PacketPlayOutEntityTeleport"),
                        // Todo find NMS name
                        new PacketInfo<>(0x58, PacketPlayServerAdvancements.class, "PacketPlayOutAdvancements"),
                        new PacketInfo<>(0x59, PacketPlayServerUpdateAttributes.class,  "PacketPlayOutUpdateAttributes"),
                        new PacketInfo<>(0x5A, PacketPlayServerEntityEffect.class,"PacketPlayOutEntityEffect"),
                        // Todo find NMS name
