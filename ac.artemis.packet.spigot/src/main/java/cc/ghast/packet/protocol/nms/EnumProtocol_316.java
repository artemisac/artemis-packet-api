    ...
    PLAY(
            new PacketPair(
                ...
                new PacketInfo[] {
                        ...
                        new PacketInfo<>(0x49, GPacketPlayServerEntityTeleport.class, "PacketPlayOutEntityTeleport"),
                        // Todo find NMS name
                        new PacketInfo<>(0x4A, GPacketPlayServerUpdateAttributes.class,  "PacketPlayOutUpdateAttributes"),
                        new PacketInfo<>(0x4B, GPacketPlayServerEntityEffect.class,"PacketPlayOutEntityEffect"),
                }
            )
    ),
