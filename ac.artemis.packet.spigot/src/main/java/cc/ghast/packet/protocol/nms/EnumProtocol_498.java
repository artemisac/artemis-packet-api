...
@AllArgsConstructor
@Getter
public enum EnumProtocol_498 implements EnumProtocol {
    HANDSHAKE(
            new PacketPair(
                new PacketInfo[]{
    ...
    PLAY(
            new PacketPair(
                ...
                new PacketInfo[] {
                        ...
                        new PacketInfo<>(0x43, GPacketPlayServerEntityMetadata.class, "PacketPlayOutEntityMetadata"),
                        new PacketInfo<>(0x44, GPacketPlayServerEntityAttach.class, "PacketPlayOutAttachEntity"),
                        new PacketInfo<>(0x45, GPacketPlayServerEntityVelocity.class, "PacketPlayOutEntityVelocity"),
                        new PacketInfo<>(0x46, GPacketPlayServerEntityEquipment.class, "PacketPlayOutEntityEquipment"),
                        ...
                        // Find NMS Name
                        new PacketInfo<>(0x5C, PacketPlayServerPlayerDigging.class, "PacketPlayOutPlayerDig")
                }
            )
    ),
