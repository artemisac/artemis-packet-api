package cc.ghast.packet.wrapper.buffer;
...
public class ProtocolByteBuf extends ByteBuf {
    private final ByteBuf byteBuf;
    private final int version;

    public ProtocolByteBuf(final ByteBuf byteBuf) {
        this.byteBuf = byteBuf;
        this.version = 5;
    }

    public ProtocolByteBuf(ByteBuf byteBuf, int version) {
        this.byteBuf = byteBuf;
