...
@AllArgsConstructor
@Getter
public enum EnumProtocol_735 implements EnumProtocol {
    HANDSHAKE(
            new PacketPair(
                new PacketInfo[]{
    ...
    PLAY(
            new PacketPair(
                ...
                new PacketInfo[] {
                        ...
                        new PacketInfo<>(0x04, PacketPlayServerSpawnNamedEntity.class, "PacketPlayOutNamedEntitySpawn"),
                        new PacketInfo<>(0x05, PacketPlayServerAnimation.class, "PacketPlayOutAnimation"),
                        ...
                        new PacketInfo<>(0x11, PacketPlayServerBlockChangeMulti.class, "PacketPlayOutMultiBlockChange"),
                        new PacketInfo<>(0x12, PacketPlayServerTabComplete.class, "PacketPlayOutTabComplete"),
                        // Todo figure out NMS name for this
                        new PacketInfo<>(0x13, PacketPlayServerCommandsDeclare.class, "PacketPlayOutDeclareCommands"),
                        new PacketInfo<>(0x14, PacketPlayServerTransaction.class, "PacketPlayOutTransaction"),
                        new PacketInfo<>(0x15, PacketPlayClientWindowClose.class, "PacketPlayInCloseWindow"),
                        new PacketInfo<>(0x16, PacketPlayServerWindowItems.class, "PacketPlayOutWindowItems"),
                        new PacketInfo<>(0x17, PacketPlayServerWindowData.class, "PacketPlayOutWindowData"),
                        new PacketInfo<>(0x18, PacketPlayServerSetSlot.class, "PacketPlayOutSetSlot"),
                        new PacketInfo<>(0x19, PacketPlayServerSetCooldown.class, "PacketPlayOutSetCooldown"),
                        new PacketInfo<>(0x1A, PacketPlayServerCustomPayload.class, "PacketPlayOutCustomPayload"),
                        new PacketInfo<>(0x1B, PacketPlayServerSoundEffectNamed.class, "PacketPlayOutNameSoundEffect"),
                        new PacketInfo<>(0x1C, PacketPlayServerKickDisconnect.class, "PacketPlayOutKickDisconnect"),
                        new PacketInfo<>(0x1D, PacketPlayServerEntityStatus.class, "PacketPlayOutEntityStatus"),
                        ...
                        // Todo find NMS
                        new PacketInfo<>(0x21, PacketPlayClientWindowHorse.class, "PacketPlayOutOpenHorseWindow"),
                        new PacketInfo<>(0x22, PacketPlayServerKeepAlive.class, "PacketPlayOutKeepAlive"),
                        // AKA Chunk Data
                        new PacketInfo<>(0x23, PacketPlayServerChunkLoad.class, "PacketPlayOutMap"),
                        // AKA Effect
                        new PacketInfo<>(0x24, PacketPlayServerWorldEvent.class, "PacketPlayOutWorldEvent"),
                        // AKA Particles
                        new PacketInfo<>(0x25, PacketPlayServerWorldParticles.class, "PacketPlayOutWorldParticles"),
                        new PacketInfo<>(0x26 , PacketPlayServerUpdateLight.class, "PacketPlayOutUpdateLight"),
                        // AKA Join Game
                        new PacketInfo<>(0x27, PacketPlayServerLogin.class, "PacketPlayOutLogin"),
                        // AKA Map
                        new PacketInfo<>(0x28, PacketPlayServerMap.class, "PacketPlayOutMap"),
                        // Todo find NMS
                        new PacketInfo<>(0x29, PacketPlayServerTradeList.class, "PacketPlayOutTradeList"),
                        new PacketInfo<>(0x2A, PacketPlayServerEntity.PacketPlayServerRelEntityMove.class, "PacketPlayOutRelEntityMove"),
                        new PacketInfo<>(0x2B, PacketPlayServerEntity.PacketPlayServerRelEntityMoveLook.class, "PacketPlayOutRelEntityMoveLook"),
                        new PacketInfo<>(0x2C, PacketPlayServerEntity.PacketPlayServerEntityLook.class, "PacketPlayOutEntityLook"),
                        new PacketInfo<>(0x2D, PacketPlayServerEntity.class, "PacketPlayOutEntity"),
                        new PacketInfo<>(0x2E, PacketPlayClientVehicleMove.class, "PacketPlayInVehicleMove"),
                        // Todo find NMS
                        new PacketInfo<>(0x2F, PacketPlayClientBookOpen.class, "PacketPlayInOpenBook"),
                        new PacketInfo<>(0x30, PacketPlayServerWindowOpen.class, "PacketPlayOutOpenWindow"),

                        new PacketInfo<>(0x31, PacketPlayServerOpenSignEditor.class, "PacketPlayOutOpenSignEditor"),
                        // Todo figure out the MS name for this
                        new PacketInfo<>(0x32, PacketPlayServerCraftingRecipeResponse.class, "PacketPlayOutCraftingResponse"),
                        new PacketInfo<>(0x33, PacketPlayServerAbilities.class, "PacketPlayOutAbilities"),
                        new PacketInfo<>(0x34, PacketPlayServerCombatEvent.class, "PacketPlayOutCombatEvsent"),
                        // AKA Packet List Item
                        new PacketInfo<>(0x35, PacketPlayServerPlayerInfo.class, "PacketPlayOutPlayerInfo"),
                        // Todo figure out NMS name for this
                        new PacketInfo<>(0x36, PacketPlayServerPlayerFace.class, "PacketPlayOutFacePlayer"),
                        new PacketInfo<>(0x37, PacketPlayServerPosition.class, "PacketPlayOutPosition"),

                        new PacketInfo<>(0x38, PacketPlayServerCraftingRecipeUnlock.class, "PacketPlayOutUnlockRecipe"),
                        new PacketInfo<>(0x39, PacketPlayServerEntityDestroy.class, "PacketPlayOutEntityDestroy"),
                        new PacketInfo<>(0x3A, PacketPlayServerEntityEffectRemove.class, "PacketPlayOutRemoveEntityEffect"),
                        new PacketInfo<>(0x3B, PacketPlayServerResourcePackSend.class, "PacketPlayOutResourcePackSend"),
                        new PacketInfo<>(0x3C, PacketPlayServerRespawn.class, "PacketPlayOutRespawn"),
                        ...
                        new PacketInfo<>(0x3D, PacketPlayServerEntityHeadRotation.class, "PacketPlayOutEntityHeadRotation"),
                        // Todo figure out the NMS name for this
                        new PacketInfo<>(0x3E, PacketPlayServerAdvancementProgress.class, "PacketPlayOutAdvancementProgress"),
                        // Todo figure out the NMS name for this
