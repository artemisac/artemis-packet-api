...
public enum DeprecatedEnumProtocol {
    HANDSHAKE(-1) {;
        {
    ...
    DeprecatedEnumProtocol(int i) {
        this.i = i;
        this.packetMap = new EnumMap<>(EnumProtocolDirection.class);
    }

    public DeprecatedEnumProtocol addPacket(EnumProtocolDirection enumProtocolDirection, Class<? extends Packet> clazz) {
